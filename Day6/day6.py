...
if __name__ == "__main__":
    ...
    print(f"The first start-of-packet marker for the given message/s at {start_of_packet}")
    print(f"The first start-of-message marker for the given message/s at {start_of_message}")